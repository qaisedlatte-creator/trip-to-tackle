    ...
    return (
      ...
      >
        ...
        <div className="relative w-full md:w-64 lg:w-80 h-56 md:h-auto shrink-0 overflow-hidden">
          ...
          />
          {pkg.badge && (
            <div className="absolute top-3 left-3 bg-[#FF6A00] text-[#0A1F44] text-xs font-space font-bold px-3 py-1 rounded-full">
              {pkg.badge}
            </div>
          )}
        </div>
        ...
        <div className="flex-1 p-6 flex flex-col justify-between">
          <div className="space-y-3">
            ...
            <h3 className="font-playfair text-2xl font-bold text-[#0A1F44]">{pkg.name}</h3>
          ...
          <div className="flex items-center justify-between mt-5 pt-4 border-t border-gray-100">
            <div>
              ...
              <p className="font-space text-2xl font-bold text-[#0A1F44]">
                {pkg.priceLabel}
            ...
            <Button
              onClick={() => onBook?.(pkg)}
              className="bg-[#FF6A00] hover:bg-[#e89c2a] text-[#0A1F44] font-semibold px-6"
            >
              Book Now
            </Button>
          </div>
  ...
  return (
    ...
    >
      <div className="relative h-52 overflow-hidden">
        ...
        <div className="absolute bottom-3 right-3 bg-[#0A1F44]/80 backdrop-blur-sm text-white text-xs font-dm flex items-center gap-1 px-2.5 py-1.5 rounded-full">
          <Clock size={11} />
          {pkg.duration}
        </div>
      </div>
      <div className="p-5 flex flex-col flex-1">
        <h3 className="font-playfair text-xl font-bold text-[#0A1F44] mb-2">{pkg.name}</h3>
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100">
          ...
          <Button
            onClick={() => onBook?.(pkg)}
            className="bg-[#FF6A00] hover:bg-[#e89c2a] text-[#0A1F44] font-semibold"
          >
            Book Now
          </Button>
        </div>
