  ...
  return (
    <section
      style={{
        ...
        overflow: "hidden",
        background:
          "radial-gradient(ellipse at 20% 50%, #1a3060 0%, #0d1b3e 40%, #060e20 100%)",
      }}
    >
      {/* Floating orbs */}
      <div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none" }}>
        {[
          { w: 600, h: 600, top: -200, left: -100, color: "rgba(245,197,66,0.04)" },
          { w: 400, h: 400, top: "30%", right: -100, color: "rgba(30,46,88,0.8)" },
          { w: 300, h: 300, bottom: -50, left: "20%", color: "rgba(245,197,66,0.06)" },
        ].map((orb, i) => (
          <motion.div
            key={i}
            animate={{
      ...
      {/* Scroll hint */}
      <div className="bounce-scroll" style={{ color: "rgba(255,255,255,0.45)" }}>
        <div
          style={{
            display: "flex",
