      ...
      <main className="bg-[#F7F7F7]">
        <section className="relative overflow-hidden bg-[#0A1F44] px-4 pb-20 pt-32 sm:px-6 lg:px-8">
          ...
          <motion.div {...fadeUp} className="relative mx-auto max-w-6xl text-center">
            <p className="section-label mb-4 text-white/45">Team Travel</p>
            <h1 className="font-playfair text-[clamp(44px,7vw,76px)] font-bold text-white">Corporate Travel</h1>
            <p className="mx-auto mt-5 max-w-3xl font-dm text-base leading-8 text-white/62">
              Offsites, incentive tours, retreats, and conference trips built for teams that need smooth logistics,
              clear pricing, and dependable on-ground coordination.
            </p>
          </motion.div>
        </section>
        ...
        <section className="bg-[#0A1F44] px-4 py-20 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="mx-auto max-w-4xl text-center">
            <p className="section-label mb-4 text-white/45">Group Coordination</p>
            <h2 className="font-playfair text-[clamp(34px,5vw,54px)] font-bold text-white">
              Planning a Corporate Offsite
            </h2>
            <p className="mx-auto mt-4 max-w-2xl font-dm text-base leading-8 text-white/62">
              We can tailor destination, stay category, meeting format, and reward experiences around your budget and
              team size.
            </p>
            <a
